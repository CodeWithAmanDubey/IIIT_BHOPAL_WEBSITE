...
const ImageCarousel = () => {
  ...
  return(
    ...
    <div className="image-container2">
      ...
      <div className="image-wrapper">  <img src={p1} alt="Image 1" className="image" /> </div>
      <div className="image-wrapper">   <img src={p2} alt="Image 2" className="image" /> </div>
      <div className="image-wrapper">  <img src={p3} alt="Image 3" className="image" /> </div>
      </div>
    </div>
    <App/>
    </div>
